...
const CreateContact = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden mt-8">
      <div className="p-6">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Create Contact</h2>
        <form onSubmit={handleSubmit}>
          ...
          >
            {mutation.isLoading ? "Creating..." : "Create Contact"}
          </button>
          {mutation.isError && <p className="text-red-500 text-sm">Error creating contact</p>}
        </form>
      </div>
    </div>
  );
